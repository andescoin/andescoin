...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AndesCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"andes-coin.com", "bo.andes-coin.com"},
    {"104.156.225.172", "95.179.200.19"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AndesCoin is probably already running."), addrBind.ToString().c_str());
        else
